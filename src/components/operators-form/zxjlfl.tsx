...
const ZXJLFL: React.FC<ZXJLFLProps> = ({ onFinish, setOpen }) => {
  ...
  const handleFinish = async (values: Record<string, any>) => {
    ...
    const params: Record<string, any> = {
      ...
      inputs: {
        ...
        // TRAINING: "/mnt/oge/oge_mount/ogebos/algorithmData/sample_wh.shp",
        // TRAIN_SAMPLES: "/mnt/oge/oge_mount/ogebos/algorithmData/area_wh.shp",
        // TRAINING_CLASS: "name",
        GRIDS,
  ...
  const handleCancel = useCallback(() => {
    setOpen(false);
    eventEmitter.emit("compute:pause", "最小距离分类");
  }, []);
